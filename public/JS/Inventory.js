...
$(document).ready(function() {
    ...
    $.get("http://localhost:8080/dsaApp/user/inventory", function (data) {
            ...
            while(i<data.lista.length) {
                if (data.lista[i] == "fusildetambor") {
                    contfusil = 1;
                }
                if (data.lista[i] == "katana") {
                    contkatana = 1;
                }
                if (data.lista[i] == "corredera") {
                    contcorredera = 1;
                }
                if (data.lista[i] == "keyblue") {
                    contkeyblue++;
                }
                if (data.lista[i] == "keyred") {
                    contkeyred++;
                }
                if (data.lista[i] == "keyyellow") {
                    contkeyyellow++;
                }
                if (data.lista[i] == "clueblue") {
                    contclueblue++;
                }
                if (data.lista[i] == "cluered") {
                    contcluered++;
                }
                if (data.lista[i] == "clueyellow") {
                    contclueyellow++;
                }
                i++;
            }
        ...
        if(contclueyellow==0) {
            console.log("Hola",7);
            document.getElementById('clue_yellow').src = "https://pngimage.net/wp-content/uploads/2018/05/candados-png-6.png";
            ...
            console.log("Hola",8);
            document.getElementById('clue_yellow').src ="https://i.pinimg.com/originals/d3/c8/60/d3c860c48ad9f9bb48346528f74d3f48.png";
            var conte = document.getElementById('contenedor_yellow');
            conte.style.display = "block";
        ...
        if(contclueblue==0) {
            console.log("Hola",9);
            document.getElementById('clue_blue').src ="https://pngimage.net/wp-content/uploads/2018/05/candados-png-6.png";
            ...
            document.getElementById('clue_blue').src ="https://4.bp.blogspot.com/-w6rNRWPnMFU/UmFae6uZLyI/AAAAAAAABBM/-R1T3m-Pm2I/s640/preguntas.png";
            var conte = document.getElementById('contenedor_blue');
            conte.style.display = "block";
        ...
        if(contcluered==0) {
            console.log("Hola",11);
            document.getElementById('clue_red').src ="https://pngimage.net/wp-content/uploads/2018/05/candados-png-6.png";
            ...
            console.log("Hola",12);
            document.getElementById('clue_red').src ="https://pngimage.net/wp-content/uploads/2018/06/interrogantes-png-6.png";
            var conte = document.getElementById('contenedor_red');
            conte.style.display = "block";
        ...
        if(contkeyyellow==0) {
            console.log("Hola",13);
            document.getElementById('key_yellow').src ="https://pngimage.net/wp-content/uploads/2018/05/candados-png-6.png";
            document.getElementById('key_yellow').width ="250";
            document.getElementById('key_yellow').height ="165";
            ...
            console.log("Hola",14);
            document.getElementById('key_yellow').src ="https://scontent-mad1-1.xx.fbcdn.net/v/t1.0-9/59627072_2381151755270864_7056317532851929088_n.jpg?_nc_cat=111&_nc_ht=scontent-mad1-1.xx&oh=2b3a0a634a078c0fdd3e487fccfac39d&oe=5D5EBFF3";
            var conte = document.getElementById('contenedorkey_yellow');
            conte.style.display = "block";
        ...
        if(contkeyblue==0) {
            console.log("Hola",15);
            document.getElementById('key_blue').src ="https://pngimage.net/wp-content/uploads/2018/05/candados-png-6.png";
            document.getElementById('key_blue').width ="250";
            document.getElementById('key_blue').height ="165";
            ...
            console.log("Hola",16);
            document.getElementById('key_blue').src ="https://scontent-mad1-1.xx.fbcdn.net/v/t1.0-9/59904610_2381158021936904_3630824489995993088_n.jpg?_nc_cat=105&_nc_ht=scontent-mad1-1.xx&oh=b09ac4773b91ee855ae246c60469be4e&oe=5D2FAC40";
            var conte = document.getElementById('contenedorkey_blue');
            conte.style.display = "block";
        ...
        if(contkeyred==0) {
            console.log("Hola",17);
            document.getElementById('key_red').src ="https://pngimage.net/wp-content/uploads/2018/05/candados-png-6.png";
            document.getElementById('key_red').width ="250";
            document.getElementById('key_red').height ="165";
            ...
            console.log("Hola",18);
            document.getElementById('key_red').src ="https://scontent-mad1-1.xx.fbcdn.net/v/t1.0-9/60104433_2381144115271628_7427805772727189504_n.jpg?_nc_cat=103&_nc_ht=scontent-mad1-1.xx&oh=ea2c6e453da7810df10e08054d6b06f3&oe=5D68709D";
            var conte = document.getElementById('contenedorkey_red');
            conte.style.display = "block";
